...
DATA sm2prmK0<>+0x00(SB)/8, $0x0000000000000001
DATA sm2prime<>+0x00(SB)/8, $0xFFFFFFFFFFFFFFFF
DATA sm2prime<>+0x08(SB)/8, $0xFFFFFFFF00000000
DATA sm2prime<>+0x10(SB)/8, $0xFFFFFFFFFFFFFFFF
DATA sm2prime<>+0x18(SB)/8, $0xFFFFFFFEFFFFFFFF
...
GLOBL sm2prmK0<>(SB), 8, $8
GLOBL sm2prime<>(SB), 8, $32
...
TEXT ·sm2PointAddAsm(SB),0,$672-72
	// Move input to stack in order to free registers
	MOVQ res+0(FP), AX
	MOVQ in1+24(FP), BX
	MOVQ in2+48(FP), CX
